...
public class Zombie
{
    ...
    public static String  casoDos()
    {
        ...
        if(Zombie.zombies.size()>0)
        {
            for(int x = 0; x<Zombie.zombies.size();x++)
            {
                ...
                contador= contador+"Este es el zombie # " + x + ", su nombre es " + a.getNombre() + ", su numero en salud es " +a.getSalud() + ", su tipo de sangre es " + a.getTipoDeSangre() + " y nació en " + a.getDate() +"\n";
            }
        }
        else
        {
  ...
  public static String casoTres()
    {        
        return ("El número de zombies creados hasta el momento son: " + Zombie.zombies.size());
       ...
       String contador= "";
        if(Zombie.zombies.size()>0)
        {
            for (int x = 0; x < Zombie.zombies.size(); x++)
            {
                ...
                {
                    contador= contador+ "Este es el zombie # " + x + ", su nombre es " + a.getNombre() + ", su numero en salud es " + a.getSalud() + ", su tipo de sangre es " + a.getTipoDeSangre() + " y nació en el año " + a.getDate()+ "\n";
                }
            }
        }
        else
  ...
  public static String casoOnce(){
    String frase1 = "Cuando los muertos echan a andar, ¿para qué obstinarse en matarlos? No hay formas de vencerlos.";
